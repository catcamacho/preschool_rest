...
output_dir = studyhome + '/proc/analysis4grp'
cope_dir = studyhome + '/proc/analysis'
workflow_dir = studyhome + '/workflows'
roi_dir = studyhome + '/ROIs'
group_con = studyhome + '/misc/tcon_4groups.con'
group_mat = studyhome + '/misc/design_4groups.mat'
proc_cores = 2
...
Lvmpfc = roi_dir + '/L_vmpfc_6mm.nii'
Rvmpfc = roi_dir + '/R_vmpfc_6mm.nii'
#Lofc = roi_dir + '/L_ofc_6mm.nii'
#Rofc = roi_dir + '/R_ofc_6mm.nii'

ROIs = [Lamyg, Ramyg, Lvmpfc, Rvmpfc]
rois = ['L_amyg','R_amyg','L_vmpfc','R_vmpfc']
...
sbc1_workflow2.base_dir = workflow_dir
sbc1_workflow2.write_graph(graph2use='flat')
sbc1_workflow2.run('MultiProc', plugin_args={'n_procs': proc_cores})
...
sbc2_workflow3 = Workflow(name='sbc2_workflow3')
sbc2_workflow3.connect([(infosource2,datagrabber,[('roi','roi')]),
...
sbc2_workflow3.base_dir = workflow_dir
sbc2_workflow3.write_graph(graph2use='flat')
sbc2_workflow3.run('MultiProc', plugin_args={'n_procs': proc_cores})
...
sbc3_workflow3 = Workflow(name='sbc3_workflow3')
sbc3_workflow3.connect([(infosource3,selectfiles2, [('roi','roi')]),
...
sbc3_workflow3.base_dir = workflow_dir
sbc3_workflow3.write_graph(graph2use='flat')
sbc3_workflow3.run('MultiProc', plugin_args={'n_procs': proc_cores})
